 ...
 *
 * $Id: at86rf212.h 12405 2008-12-04 07:25:13Z uwalter $
 *
...
#define SS_HIGH() gpio_set_value(SSpin, 1);
...
#define COMPLIANT_DATA_RATE_LOW     (0)

/** Constant COMPLIANT_DATA_RATE_LOW for sub-register SUB_MODE in register RG_TRX_CTRL_2 */
#define COMPLIANT_DATA_RATE_HIGH     (1)
